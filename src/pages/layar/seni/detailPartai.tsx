...
const detailPartai = (props: Props) => {
  return (
    <div className='py-10 px-16 min-h-[90vh]'>
        <div className='h-12 w-full flex justify-between space-x-4'>
            ...
            <div className='bg-[#2C2F48] w-[95%] rounded-xl flex justify-center items-center'>
                <h1 className='text-3xl text-white font-lato font-bold uppercase'>PARTAI 17 - TUNGGAL - PUTRA REMAJA - PENYISIHAN</h1>
            </div>
        </div>
...
detailPartai.getLayout = (page: ReactElement) =>{
    return (
        <EventLayout>
            {page}
        </EventLayout>
