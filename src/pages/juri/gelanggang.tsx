        ...
        <div className='py-10 px-12 min-h-[90vh]'>
            ...
            <div className='grid grid-cols-2 gap-8 my-8'>
                <div className="flex flex-col justify-center items-center border-2 border-[#222954] py-6 rounded-xl space-y-2 mb-3">
                    ...
                    <button type='button' onClick={() => router.push('/juri/tanding/I/')} className='lg:text-3xl md:text-xl uppercase text-white font-medium bg-[#39ac39] hover:bg-[#2f912f] w-[85%] rounded-xl py-2 text-center'>Detail</button>
                </div>
                <div className="flex flex-col justify-center items-center border-2 border-[#222954] py-4 rounded-xl space-y-2 mb-3">
                    ...
                    <button type='button' onClick={() => router.push('/juri/seni/II/')} className='text-3xl md:text-xl uppercase text-white font-medium bg-[#39ac39] hover:bg-[#2f912f] w-[85%] rounded-xl py-2 text-center'>Detail</button>
                </div>
            </div>
        </div>
    )
