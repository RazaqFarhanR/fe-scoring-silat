    ...
    return (
        <div className='h-auto'>
            <header className='w-full bg-sideAdmin'>
                <h1 className='font-lato font-bold text-sm text-white px-3 py-1'>JADWAL TUNGGAL</h1>
            </header>
            ...
            <main className='px-8 py-4 h-[90vh] space-y-4'>
                <div className='bg-darkBlue w-full h-14 rounded-md flex justify-between items-center px-5'>
                    <h1 className='text-white font-bold text-2xl'>JADWAL TUNGGAL</h1>
...
JadwalTunggal.getLayout = (page: ReactElement) =>{
    return (
        <AdminLayout>
            {page}
        </AdminLayout>
