...
const ListJadwalTanding = ({index,gelanggang,partai,kelas,jk,peserta_biru,kontingen_biru,peserta_merah,kontingen_merah,babak}: Props) => {
  return (
...
export default ListJadwalTanding